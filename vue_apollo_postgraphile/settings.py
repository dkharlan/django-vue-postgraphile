"""
Django settings for vue_apollo_postgraphile project.
...
CORS_ORIGIN_WHITELIST = [
  require_env('FRONTEND_RESOURCES_DOMAIN')
]

ROOT_URLCONF = 'vue_apollo_postgraphile.urls'
...
WSGI_APPLICATION = 'vue_apollo_postgraphile.wsgi.application'
